  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/ZakL1K1/UNIVERCITY/blob/main/Practice/Practice_3.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "8cdb4bae-af41-49f2-e0b1-55929652cdf0"
      },
      "execution_count": 3,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "e015f36d-240e-453c-f94d-5cc35dda6ab2"
      },
      "execution_count": 5,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "    def __str__(self):\n",
        "        avg_grade = self._get_avg_hw_grade()\n",
        ...
        "\n",
        "    def __str__(self):\n",
        "        avg_grade = self._get_avg_lecture_grade()\n",
        "        return f\"Имя: {self.name}\\nФамилия: {self.surname}\\n\" \\\n",
        "               f\"Средняя оценка за лекции: {avg_grade:.1f}\"\n",
        "\n",
        "    def _get_avg_lecture_grade(self):\n",
        "        if not self.grades:\n",
        "            return 0.0\n",
        "\n",
        "        all_grades = []\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "            return False\n",
        "        return self._get_avg_hw_grade() == other._get_avg_hw_grade()\n",
        "\n",
        ...
        "            return NotImplemented\n",
        "        return self._get_avg_lecture_grade() < other._get_avg_lecture_grade()\n",
        "\n",
        "    def __le__(self, other):\n",
        "        if not isinstance(other, Lecturer):\n",
        "            return NotImplemented\n",
        ...
        "            return f\"Совместная проверка: {self.name} {self.surname} и {other.name} {other.surname}\"\n",
        "        return NotImplemented"
      ],
      "metadata": {
        "id": "WNCf9PPMu4Gv"
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "\n",
        "def get_avg_hw_grade_for_course(students, course_name):\n",
        "    total_grades = []\n",
        ...
        "\n",
        "\n",
        "def get_avg_lecture_grade_for_course(lecturers, course_name):\n",
        "    total_grades = []\n",
        ...
        "\n",
        "avg_hw_python = get_avg_hw_grade_for_course(students_list, 'Python')\n",
        "avg_lecture_python = get_avg_lecture_grade_for_course(lecturers_list, 'Python')\n",
        "\n",
        ...
        "\n",
        "print(f\"\\nСравнение студентов: student1 > student2 = {student1 > student2}\")\n",
      ...
      "metadata": {
        ...
        "outputId": "11292954-baf9-44e1-8649-e53fe23cde2c"
      },
      "execution_count": 9,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Завершенные курсы: Нет завершенных курсов\n",
            "\n",
            "Лекторы:\n",
            "Имя: John\n",
            "Фамилия: Doe\n",
            ...
            "Фамилия: Brown\n",
            "\n",
            "Средняя оценка за домашние задания по курсу Python: 8.3\n",
            "Средняя оценка за лекции по курсу Python: 9.0\n",
            "\n",
            "Сравнение студентов: student1 > student2 = True\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "    def reciprocal(self):\n",
        "        if self.numerator == 0:\n",
        "            raise ZeroDivisionError(\"Обратная дробь не существует для нуля\")\n",
        "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "22636ed2-8dfa-4cb9-9382-eb4622a529b7"
      },
      "execution_count": 17,
      "outputs": [
        {
